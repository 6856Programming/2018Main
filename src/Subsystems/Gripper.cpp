...
Gripper::Gripper() : frc::Subsystem("Gripper")
{
	...
	this->m_pGripperOpenLimitSwitch = new frc::DigitalInput(GRIPPER_LIMIT_OPEN_DIO_ID);		// On Rio PID pins, number 0 to ??
	this->m_pGripperClosedLimitSwitch = new frc::DigitalInput(GRIPPER_LIMIT_CLOSED_DIO_ID);
...
{
	return this->m_pGripperOpenLimitSwitch->Get();
}

bool Gripper::getGripperClosedLimitSwitchStatus(void)
{
	return this->m_pGripperClosedLimitSwitch->Get();
}
